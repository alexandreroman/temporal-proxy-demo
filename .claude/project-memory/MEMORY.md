...
- [Demo scope and scenarios](references/project_demo-scope.md) — the scenarios in scope, and what is not
...
- [Switching upstreams is a proxy-config change](references/feedback_scenario-switch.md) — one Kustomize overlay and configuration file per scenario, selected by `SCENARIO`
