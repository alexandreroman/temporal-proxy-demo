...
- [The kms card names the role, not the transport](references/feedback_kms-card-names-the-role.md) — the platform's key store, and what it omits
...
- [The diagram is cards joined by static SVG wires](references/project_diagram-is-cards-and-wires.md) — one card size, hard-coded wires
- [The rail is grouped by persona](references/project_rail-grouped-by-persona.md) — three dashed groups, an upstream in none, and what hover reveals
