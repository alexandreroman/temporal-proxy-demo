...
- [The key service card names the role, not the transport](references/feedback_kms-card-names-the-role.md) — a role, not a component
...
- [The rail is grouped by persona](references/project_rail-grouped-by-persona.md) — three dashed groups, an upstream in none, and what hover shows
